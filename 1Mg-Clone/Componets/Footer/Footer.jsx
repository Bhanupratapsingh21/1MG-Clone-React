    ...
    return (
        <>
            <div className="footerboxtext">
                <p>
                    <b>Stay Healthy with Tata 1mg: Your Favourite Online Pharmacy and Healthcare Platform</b>
                    <br />
                    <b>We Bring Care to Health.</b>
                    <br />
                    ...
                    <br />
                    <b>Tata 1mg: Your Favourite Online Pharmacy!</b>
            ...
            <div className="footerboxlast">
                <h3>This Whole Project Is Created By <Link style={{color : 'black'}} to='https://bhanupratapsingh21.github.io/Portfolio-Website/#'><b>@BPSS</b></Link></h3>
                <h5>If You Are Looking For Fotter It Is Not A Real 1MG Website</h5>
                <h5><Link style={{color : 'black'}} to='https://www.1mg.com/' ><b>Real One</b></Link></h5>
            </div>
        </>
    )
}
